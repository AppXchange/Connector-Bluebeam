...
public class SetStatusFinalizingHandler : IActionHandler<SetStatusFinalizingAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<SetStatusFinalizingActionOutput>();
            // response = await _apiClient.PostFinalizingDataObject(input, cancellationToken)
            ...
            // var resource = await _apiClient.GetFinalizingDataObject(response.Data.id, cancellationToken);

            // var resource = new SetStatusFinalizingActionOutput
            // {
            //      TODO : map
            // };
            ...
            {
                new CacheSyncCollection() { DataObjectType = typeof(FinalizingDataObject), CacheChanges = operations.ToArray() }
            };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "SetStatusFinalizingHandler" };
