...
/// are intended to be.
/// </summary>
[Description("SubscribeFileFolderSubscriptionAction Action description goes here")]
...
{
    public SubscribeFileFolderSubscriptionActionInput ActionInput { get; set; } = new();
