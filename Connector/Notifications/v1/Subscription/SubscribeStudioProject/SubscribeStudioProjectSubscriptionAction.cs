...
/// are intended to be.
/// </summary>
[Description("SubscribeStudioProjectSubscriptionAction Action description goes here")]
...
{
    public SubscribeStudioProjectSubscriptionActionInput ActionInput { get; set; } = new();
