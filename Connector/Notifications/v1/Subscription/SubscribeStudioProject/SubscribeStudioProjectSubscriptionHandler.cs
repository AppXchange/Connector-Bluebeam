...
public class SubscribeStudioProjectSubscriptionHandler : IActionHandler<SubscribeStudioProjectSubscriptionAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<SubscribeStudioProjectSubscriptionActionOutput>();
            ...
            // var resource = new SubscribeStudioProjectSubscriptionActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "SubscribeStudioProjectSubscriptionHandler" };
