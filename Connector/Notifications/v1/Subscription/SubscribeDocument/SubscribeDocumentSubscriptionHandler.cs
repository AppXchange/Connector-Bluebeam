...
public class SubscribeDocumentSubscriptionHandler : IActionHandler<SubscribeDocumentSubscriptionAction>
{
    ...
    public async Task<ActionHandlerOutcome> HandleQueuedActionAsync(ActionInstance actionInstance, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var response = new ApiResponse<SubscribeDocumentSubscriptionActionOutput>();
            ...
            // var resource = new SubscribeDocumentSubscriptionActionOutput
            // {
            //      TODO : map
            // };
        ...
        catch (HttpRequestException exception)
        {
            ...
            var errorSource = new List<string> { "SubscribeDocumentSubscriptionHandler" };
